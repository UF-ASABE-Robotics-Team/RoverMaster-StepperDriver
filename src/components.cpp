...
void init() {
  ...
  SERIAL_DOWNSTREAM.begin(115200, SERIAL_8N1, A2, A1);
...
Stepper::Motor *stepper_list[] = {
    new Stepper::Motor("J1",
                       ...
                       TMC2209::hook_init(new TMC2209::Config{
                           .port = reinterpret_cast<Stream *>(&Serial2),
                           .addr = 0b00,
                           .R_SENSE = 0.11f,    // Ohm
                           .rms_current = 1200, // mA
                           .micro_steps = 8,
...
Stepper::Motor *stepper_list[] = {
    new Stepper::Motor(
        ...
        Stepper::StepperInfo{
            ...
            .ratio = MICRO_STEP(8) / 6.0,
            .backoff = 10.0,
            .margin = {.left = 10, .right = 10, .offset = 0, .enforce = false},
            .origin = Stepper::HomingOrigin::MIDDLE,
            .speed = 60.0,
        },
        TMC2209::hook_init(
    ...
    new Stepper::Motor(
        ...
        Stepper::StepperInfo{
            ...
            .ratio = 8.0 * (MICRO_STEP(8) / 360.0) / 2.0,
            .backoff = 10.0,
            .margin = {.left = 5, .right = 5, .offset = 0, .enforce = false},
    ...
    new Stepper::Motor(
        ...
        Stepper::StepperInfo{
            ...
            .ratio = MICRO_STEP(32) / 3.0,
            .backoff = 15.0,
            .margin =
                {.left = 10, .right = 10, .offset = 180, .enforce = false},
            .origin = Stepper::HomingOrigin::MIDDLE,
            .speed = 90.0,
        },
        TMC2209::hook_init(
